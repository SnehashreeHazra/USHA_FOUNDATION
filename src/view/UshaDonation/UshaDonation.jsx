      ...
      <div className="usha-donation">
        <div className="donation-banner">
          <div className="uni-container about-container0">
            <div className="mission-why-usha-btn">
              ...
              <span onClick={() => navigate("/usha-membership")}>
                Membership
              </span>
            </div>
        ...
        <div className="uni-container">
          <p className="body-first-text">
            ...
            offerings . Your support empowers the preservation and propagation
            of India's timeless wisdom.
          </p>
          ...
          <p className="usha-donate-text">
            ...
            three sacred debts: to the Divine (Deva ṛṇa), to the Sages (Ṛṣi
            ṛṇa), and to our Ancestors (Pitṛ ṛṇa). While family traditions help
            us honour our forebears, the debts to the Divine and to the Rishis
            invite us to give back to the larger spiritual and cultural heritage
            that has quietly shaped our lives.
          </p>
          <p className="usha-donate-text">
            ...
            it's supporting temple conservation, funding Vedic education,
            enabling Sanskrit digitisation, or nurturing Dharma-based learning
            spaces, your contribution becomes an act of silent gratitude.
          </p>
          <p className="usha-donate-text">
            By choosing to engage, you’re not just giving—you’re participating
            in the renewal of a shared civilisational legacy. In doing so, the
            sacred debts we owe are not just repaid, but reborn into a future
            that remembers.
          </p>
          ...
          <div className="usha-donation-form">
            ...
            <div className="form-wrapper">
              <div className="donation-form-left">
                ...
                <p className="donation-amount">or</p>
                <div className="email-input">
